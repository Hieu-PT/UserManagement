...
public class SearchPromotionController extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(SearchPromotionController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HashMap<String, UserDTO> result;
            if(promotion == null){
                request.setAttribute("MESSAGE", "Your promotion list is null");
            }else {
                
                result = promotion.getPromotionList();
                request.setAttribute("INFO", result);
            }
        } catch (Exception e) {
            LOGGER.error("ERROR at SearchPromotionController: " + e.getMessage());
        } finally {
