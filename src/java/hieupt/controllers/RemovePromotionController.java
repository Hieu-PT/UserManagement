...
public class RemovePromotionController extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(RemovePromotionController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            LOGGER.error("ERROR at RemovePromotionController: " + e.getMessage());
        } finally {
